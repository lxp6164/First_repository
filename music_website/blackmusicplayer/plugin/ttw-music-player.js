    ...
    $.fn.ttwMusicPlayer = function(playlist, userOptions) {
        ...
        playlistMgr = function() {
            ...
            markup = {
				...
				//真正执行的居然还是这里，下面的只是做了修改
				//但是为什么不是标准型的<a>xxx</a>，通过点击xxx来打开超链接
				//而是点击那个框？
                            '<a href="#" class="buy not-active" download></a>' +
						'</li>',
...
//在这修改，增加点击download（原buy,price等）后发出警告（是/否）
...
//为什么不需要click？点击根本不是这啊。。。这里只是改变
//超链接根本不需要click...
//但是又不是一般的超链接，无语。。。还是得点击才会产生一个bug的链接啊！！！
            function setBuyLink($track, index) {
             ...
             //      $track.find(cssSelector.buy).attr("onclick","javascript:alert('即将进行下载，无法阻止，小心点击')");
//无论如何都会下载。。。
...
//.........................................................................
        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                ...
                markup = '<div id="tmp_change" class="ttw-music-player">' +
